...
export class MiddleComponent implements OnChanges, OnInit, AfterViewInit {
  ...
  @Input() leftSideElement!: { el: Item | null | string, side: string } | string[]
  @Input() rightSideElement!: { el: Item | null | string, side: string } | string[]
  @Input() topRightElement!: { el: Item | null, side: string }
  @Input() topLeftElement!: { el: Item | null, side: string }
  @Input() color: string = ''

  public imgSrc = `assets/img/constr/main${this.color}.png`
  ...
  ngOnChanges(changes: SimpleChanges): void {
    this.imgSrc = `assets/img/constr/main${this.color}.png`
    if (changes) {
